...
export const ControlPanel: React.FC<ControlPanelProps> = ({ channel }) => {
  ...
  return (
    // Mengubah container utama menjadi h-screen dan w-full agar mengikuti ukuran jendela
    <div className="h-screen w-full bg-white flex flex-col font-sans overflow-hidden">
      
        {/* Header Panel - Sticky at Top */}
        <div className="bg-gray-900 p-3 text-white border-b-4 border-yellow-500 relative flex flex-col items-center shrink-0">
            
            {/* Pop Out Button */}
            <button 
                onClick={handlePopOut}
                className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white transition p-2 rounded-full hover:bg-gray-800"
                title="Buka di Jendela Terpisah"
            >
                <ExternalLink size={18} />
            </button>

            <h1 className="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-0.5">Panel Petugas</h1>
            <h2 className="text-base font-black text-white leading-tight text-center">Lapas Kelas I Madiun</h2>
            
            {/* Connection Indicator */}
            <div className={`absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 text-[9px] uppercase font-bold px-2 py-1 rounded-full ${isConnected ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400 animate-pulse'}`}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col">
            ...
            {/* SECTION 1: ALERT & COUNTER SELECTION */}
            <div className="p-4 pb-2 bg-white shrink-0">
                {!isConnected && (
            ...
            <div className="flex border-y border-gray-200 shrink-0">
                <button 
            ...
            <div className="p-4 pt-4 flex-1 flex flex-col justify-start">
        ...
        {/* Footer Status - Sticky at Bottom */}
        <div className="bg-gray-50 p-2 text-center text-[10px] text-gray-400 border-t border-gray-200 shrink-0">
